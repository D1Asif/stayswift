...
export default async function BookingCard({ hotelId, checkin, checkout }) {
    ...
    const totalCost = ((hotelInfo?.lowRate + hotelInfo?.highRate) / 2) * days;
    ...
    return (
        <div className="flex justify-between items-center ">
            ...
            <div>
                ...
                <p className="text-sm text-gray-600">${(hotelInfo?.lowRate + hotelInfo?.highRate) / 2} per night x {days} days</p>
            </div> 
        </div>
    )
}
